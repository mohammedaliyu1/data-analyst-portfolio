...
## Dataset Description
The dataset contains monthly retail sales data including:
- Total Orders
- Gross Sales
- Discounts
- Returns
...
## Analysis Performed
- Seasonal sales performance analysis by month
- Revenue composition analysis (gross sales vs discounts and returns)
- Order volume vs sales value comparison
